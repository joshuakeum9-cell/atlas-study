...
const CONCEPTS: Record<string, string[]> = {
  bracket: ['expanding brackets', 'distributing', 'negative sign'],
  brackets: ['expanding brackets', 'distributing', 'negative sign'],
  expand: ['expanding brackets', 'distributing'],
  expanding: ['expanding brackets', 'distributing'],
  distribute: ['expanding brackets', 'distributing'],
  minus: ['negative sign', 'expanding brackets'],
  negative: ['negative sign', 'expanding brackets'],
  sign: ['negative sign', 'expanding brackets'],
  solve: ['solving equations'],
  solving: ['solving equations'],
  equation: ['solving equations'],
  equations: ['solving equations'],
  simplify: ['expanding brackets', 'distributing'],
  terms: ['expanding brackets'],
...
export const searchExamples = [
  'the notes where I struggled with the minus sign',
  'the page I photographed for worksheet 5',
  'the quiz where I lost marks',
  'anything about expanding brackets',
]
